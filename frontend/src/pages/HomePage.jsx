...
function HomePage() {
  ...
  return (
    <>
      <Nav onProfileClick={() => setProfileOpen(true)} />
        ...
        <div style={styles.overlay} onClick={() => setProfileOpen(false)}>
          <div style={{ ...styles.sheet, maxWidth: isMobile ? "100%" : 480 }} onClick={e => e.stopPropagation()}>
            ...
            <div style={styles.profileStatRow}>
              {[{ val: "24", lbl: "Sessions" }, { val: "8 wks", lbl: "Streak" }, { val: "Pro", lbl: "Plan" }].map(s => (
...
const styles = {
  ...
  profileBtn: {
    ...
    fontSize: 15, flexShrink: 0, marginLeft: "auto",
  },
  hero: {
    display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center",
    minHeight: "calc(100vh - 65px)", background: "#0d0d0f",
    position: "relative", overflow: "hidden",
    padding: "40px clamp(20px, 5vw, 80px)",
  },
  heroInner: { width: "100%", maxWidth: 800, margin: "0 auto", zIndex: 1 },
  glow1: {
    position: "absolute", top: "10%", left: "50%", transform: "translateX(-50%)",
    width: "clamp(280px, 50vw, 600px)", height: "clamp(280px, 50vw, 600px)", borderRadius: "50%",
    background: "radial-gradient(circle, rgba(200,240,96,0.10) 0%, transparent 70%)", pointerEvents: "none",
  },
  glow2: {
    position: "absolute", bottom: "20%", right: "-5%",
    width: "clamp(180px, 30vw, 400px)", height: "clamp(180px, 30vw, 400px)", borderRadius: "50%",
    background: "radial-gradient(circle, rgba(96,212,240,0.08) 0%, transparent 70%)", pointerEvents: "none",
  },
  heroContent: { display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", width: "100%" },
  badge: {
  ...
  headline: { fontFamily: "'Syne', sans-serif", fontWeight: 800, lineHeight: 1.1, letterSpacing: "-1px", color: "#f0f0f0", marginBottom: 14 },
  subheadline: { color: "rgba(240,240,240,0.55)", marginBottom: 30, fontFamily: "'DM Sans', sans-serif" },
  ctaRow: { display: "flex", gap: 12, marginBottom: 40, flexWrap: "wrap", justifyContent: "center" },
  primaryBtn: {
    borderRadius: 50, background: "#ffc42e", color: "#0d0d0f", border: "none",
    cursor: "pointer", fontFamily: "'Syne', sans-serif", fontWeight: 700,
    boxShadow: "0 4px 24px rgba(200,240,96,0.25)",
  },
  secondaryBtn: {
    borderRadius: 50, background: "transparent", color: "#f0f0f0",
    border: "1px solid rgba(255,255,255,0.15)", cursor: "pointer",
    fontFamily: "'DM Sans', sans-serif", fontWeight: 500,
  },
  statsRow: { display: "flex", gap: "clamp(10px, 2vw, 24px)", flexWrap: "wrap", justifyContent: "center" },
  statItem: { background: "#1e1e23", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, textAlign: "center", minWidth: 80, flex: "1 1 auto" },
  statVal: { fontFamily: "'Syne', sans-serif", fontWeight: 800, color: "#ffc42e" },
  statLbl: { fontSize: 10, color: "#666", textTransform: "uppercase", letterSpacing: "1px", marginTop: 3, fontFamily: "'DM Sans', sans-serif" },
  overlay: {
  ...
  sheetHandle: { width: 40, height: 4, borderRadius: 2, background: "rgba(255,255,255,0.07)", margin: "0 auto 24px" },
  profileAvatar: {
    width: 72, height: 72, borderRadius: "50%", background: "linear-gradient(135deg, #ffc42e, #60d4f0)",
    display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28, margin: "0 auto 20px",
  },
  profileName: { fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: 18, textAlign: "center", marginBottom: 4, color: "#f0f0f0" },
  profileEmail: { fontSize: 13, color: "#666", textAlign: "center", marginBottom: 24 },
  profileStatRow: { display: "flex", gap: 12, marginBottom: 24 },
  profileStat: { flex: 1, background: "#1e1e23", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: 14, textAlign: "center" },
